...
public class AccordeonTest {
    ...
    @Test
    public void answerAccordanceQuestionsTest() {
        HomePage homePage = new HomePage(this.driver);
        homePage.closeCookieMessage();
        homePage.runToAccordion(this.index);
        boolean actualAnswer = homePage.getQuestion(this.answer);
